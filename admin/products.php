...
<body class="container mt-4" style="background:#f8f9fa;">
    ...
    <form method="post"  enctype="multipart/form-data" class="row g-3 mb-4 shadow-sm p-3" style="border-radius:8px;background:#fff;">
        ...
        <table class="table table-bordered table-hover m-0 text-center align-middle">
            ...
            <?php foreach ($products as $p): ?>
                <tr>
                    ...
                    <td><?= $p['stock'] ?></td>
                    <td>
                        <a href="edit_products.php?id=<?= $p['product_id'] ?>" class="btn btn-sm btn-warning me-1" style="border-radius:8px;">
                            <i class="bi bi-pencil-square"></i> แก้ไข </a>
                        <a href="products.php?delete=<?= $p['product_id'] ?>" class="btn btn-sm btn-danger" style="border-radius:8px;"
