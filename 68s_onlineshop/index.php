...
<title>หน้าหลัก</title>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css"><!-- ★ Icons -->

    <style>
        .product-card { background:#fff; border:1px solid #e5e5e5; border-radius:.5rem; }
        ...
        .rating i { color:#ffc107; }        /* ดาวสีทอง */
    ...
    <div class="container">
        ...
        <div class="d-flex">
            <?php if ($isLoggedIn): ?>
                ...
                <a href="orders.php" class="btn btn-sm btn-danger me-2">ประวัติการสั่งซื้อ</a>
